...
* [Charlotte.jl](https://github.com/MikeInnes/Charlotte.jl) - a Julia to WebAssembly/Javascript compiler (abandoned);
* [Julia-WASM](https://github.com/Keno/julia-wasm) - another Julia to WASM compiler. (a repl is available);
